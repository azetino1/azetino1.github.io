...
var weatherInfo = JSON.parse(weatherObject.responseText);
    ...
    document.getElementById('todayHigh').innerHTML = weatherInfo.forecast.txt_forecast.forecastday["0"].fcttext;;
    document.getElementById('todayLow').innerHTML = weatherInfo.forecast.simpleforecast.forecastday["0"].fctext;
